...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Lending and Borrowing Growing Solutions" },
      ...
      { name: "twitter:title", content: "Lending and Borrowing Growing Solutions — B2B Trade & Credit Platform" },
