...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Kredix — B2B Trade & Credit Platform" },
      { name: "twitter:description", content: "One platform for orders, payments, credit terms, and field-staff productivity." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/ec5179a4-b56c-4da4-9434-e16a06b47b54" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/ec5179a4-b56c-4da4-9434-e16a06b47b54" },
    ],
    links: [
